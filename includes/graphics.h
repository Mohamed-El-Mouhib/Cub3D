...
void			draw_square(t_data *image, t_vec2 s, int len,
					unsigned int color);
void			draw_filled_square(t_data *image, t_vec2 s, int len,
					unsigned int color);
void			draw_vertical_line(t_data *buff, t_vec2 p1, double len,
					int color);
void			draw_horizontal_line(t_data *buff, t_vec2 p1, double len,
					int color);
...
void			image_draw_transparent(t_game *game, t_data *image,
