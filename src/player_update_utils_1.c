...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   player_update_utils_1.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mel-mouh <mel-mouh@student.1337.ma>        +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/15 17:02:35 by mel-mouh          #+#    #+#             */
/*   Updated: 2026/01/15 17:03:23 by mel-mouh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * Veclociy: representing the player motion,
	combining its speed and its direction
 */
...
void	player_update_bobbing(t_game *game)
{
	...
	game->player.bob.y = fabs(cos(freq)) * -bob_amount_y;
}
...
void	player_update_sway(t_game *game)
{
	...
	if (fabs(player->sway) < 0.1)
		player->sway = 0;
	player->sway = lerp(player->sway, target_sway, PLAYER_SWAY_SPEED
			* game->dt);
}
